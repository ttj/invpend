...
%\subsubsection{Baseline Controller}
%
%\begin{figure}[h!]
%\centering
%  \hrule
%%  \two{.47}{.47}
%  {\lstinputlisting[language=ioa,lastline=14]{BaselineController.hioa}}
%  {\lstinputlisting[language=ioa,firstline=15]{BaselineController.hioa}}
%  \hrule
%  \caption{Baseline Controller}
%  \label{fig:baselineController}
%\end{figure}
%
%\subsubsection{Experimental Controller}
%
%\begin{figure}[!h]
%\centering
%  \hrule
%%  \two{.47}{.47}
%  {\lstinputlisting[language=ioa,lastline=14]{ExperimentalController.hioa}}
%  {\lstinputlisting[language=ioa,firstline=15]{ExperimentalController.hioa}}
%  \hrule
%  \caption{Experimental Controller}
%  \label{fig:experimentalController}
%\end{figure}
