...
\hypersetup{
  pdftitle={Simulations of Multi-Waypoint Flocking Problem with Delays and Saturation},
...
%\begin{figure}[!p]
%  \begin{center}
%    \includegraphics[width=3.5in]{n50m2t36}
%  \end{center}
%
%  \caption{\small N=50, m=2, Time=36s}
%  \label{fig:n50m2t36}
%\end{figure}
%
%\begin{figure}[!p]
%  \begin{center}
%    \includegraphics[width=3.5in]{n50m2t40}
%  \end{center}
%
%  \caption{\small N=50, m=2, Time=40s}
%  \label{fig:n50m2t400}
%\end{figure}
